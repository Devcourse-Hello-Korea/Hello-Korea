...
from .models import MotelInfo
from .forms import CheckinCheckoutForm
from .crawl import set_dates_and_crawl

def motel_data_view(request):
    data = None
